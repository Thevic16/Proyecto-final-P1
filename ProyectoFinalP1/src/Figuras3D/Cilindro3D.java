...
//tamano de la ventana.dim = super.getToolkit().getScreenSize();
...
*/
public void addCylinder(float radius,float height,Color3f diffuse, Color3f spec) {
...
public static void VisualidarFigura(String nombre,float radius,float height,String color) {
	...
	Cilindro3D bc = new Cilindro3D(nombre);
	//bc.setSize(700, 700);
	bc.addCylinder(radius,height,new Color3f(aux), new Color3f(aux));
