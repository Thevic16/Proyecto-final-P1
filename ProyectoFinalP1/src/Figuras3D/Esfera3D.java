...
public class Esfera3D extends JFrame {
/**
...
*/
public void addSphere(float radius,Color3f diffuse, Color3f spec) {
...
//Create a TransformGroup and make it the parent of the cone
...
public static void VisualidarFigura(String nombre,float radius) {
	Esfera3D bc = new Esfera3D(nombre);

	bc.setSize(250, 250);
	bc.addSphere(radius,new Color3f(1, 0, 0), new Color3f(1, 0, 0));
